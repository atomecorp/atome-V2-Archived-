...
module Zim_renderer
  ...
  #######  Zim objects #############
  def zim_constructor(atome_object, atome_id, *opt)
...
// we seek the following sequence postion in current script
...
//});
  ...
  def zim_gen_prop(properties, atome_id, opt)
