...
class Atome
  ...
  #def set prop
  #  #new_prop_name_to_add = prop.keys[0].to_sym
  #  ##get_parent = ObjectSpace._id2ref(prop_find.values[0])
  #  ##puts "-----"
  #  ##puts "prop: #{prop.class}"
  #  ##puts "-+-+-+-+"
  #  #prop[:parent] = object_id
  #  #@atome.each_with_index do |current_prop, index|
  #  #  if current_prop.keys[0].to_sym == new_prop_name_to_add
  #  #    @atome.delete_at(index)
  #  #  elsif current_prop.keys[0].to_sym == :parent
  #  #    get_parent = ObjectSpace._id2ref(current_prop.values[0])
  #  #    #puts "@atome: #{@atome}"
  #  #    #puts "get_parent: #{get_parent}"
  #  #    #puts "-------"
  #  #    @atome.delete_at(index)
  #  #  end
  #  #end
  ...
  #
  #  @atome << prop
  #  @atome << {:parent => object_id}
  #
  #  @atome.each do |prop_find|
  #    if prop_find.keys[0] == :parent
  #      get_parent = ObjectSpace._id2ref(prop_find.values[0])
  #      get_parent.atome << @atome[0]
  #      #puts "@atome : #{@atome[0]}"
  #      @atome.each do |atome|
  ...
  def get property
    ...
    @atome.each do |atome|
      if atome.class != Array
        ...
        #puts "atome is #{atome} the class is a  : #{atome[0].class}"
      end
    end
  ...
  def verif
    ...
    @atome.each do |atome|
      #puts "atome : #{atome}  #{atome.class}, @atome :  #{@atome} class #{@atome.class}"
