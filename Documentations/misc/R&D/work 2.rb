...
class Atome
  ...
  @@presets = {circle: "circle desc", box: "box desc", star: "star desc", triangle: "triangle desc", polygon: "polygon desc", squiggle: "squiggle desc", bloob: "bloob desc",logo: :atome_logo, distort: "distort code here",  lorem: "lorem ipsum dolore", user: "anonymous", computer: "riscPC", hello: "puts 'hello world'", foo: "this object has no body"}
  ...
  def set val, add_mode = false
    if !@@sub_property.nil?
      puts "----"
      puts "@@sub_property : #{@@sub_property}"
    end
  ...
  def get val
    ...
    if val.to_s.end_with?("s")
      ...
      # we get only the last atome that contain the requested prop
      @atome.each do |atome|
